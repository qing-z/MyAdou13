...
public class EditProfileAvatarDialog implements View.OnClickListener {
    ...
    public EditProfileAvatarDialog(Activity activity) {
    ...
    private void init() {
        ...
        ll_cancel = (LinearLayout) v.findViewById(R.id.iv_cancel);
    ...
    public EditProfileAvatarDialog(Activity activity, int themeResId) {
        this.activity = activity;
        //把dialog实例化
